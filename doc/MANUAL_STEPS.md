...
For å koble opp mot ArenaDB i q2 (nå endret til q1 med den nye views-løsningen til Arena-teamet, så jeg har oppdatert secreten):
...
* Man må få tak i noen som har rettigheter til å bytte passordet.
  Dette kan man få hjelp til i #team-azure
* Så må man få tak i noen som har rettigheter til å oppdatere det nye passordet i vault.
  Dette kan man få hjelp til i #nais
