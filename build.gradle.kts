...
dependencies {
    ...
    implementation("com.github.navikt.tiltakspenger-libs:arenatiltak-dtos:0.0.120")
    implementation("com.github.navikt.tiltakspenger-libs:arenaytelser-dtos:0.0.120")
