 ...
 */
data class PeriodeMedHull<T> private constructor(
    ...
    fun slåSammenTilstøtendePerioder(): PeriodeMedHull<T> =
        this.copy(perioderMedVerdi = perioderMedVerdi.slåSammenTilstøtendePerioder())

    fun setVerdiForDelPeriode(
        verdi: T,
        delPeriode: Periode,
    ): PeriodeMedHull<T> = setPeriodeMedVerdi(PeriodeMedVerdi(verdi, delPeriode))

    fun <U, V> kombiner(
        other: PeriodeMedHull<U>,
    ...
    fun <U> splitt(
        ...
        this.perioderMedVerdi
            ...
            .let { PeriodeMedHull(this.totalePeriode, ekstrahertVerdi(this.defaultVerdi), it) }

    fun perioder(): List<PeriodeMedVerdi<T>> = perioderMedVerdi.sortedBy { it.periode.fra }

    // Private hjelpemetoder:

    private fun setPeriodeMedVerdi(delPeriodeMedVerdi: PeriodeMedVerdi<T>): PeriodeMedHull<T> {
